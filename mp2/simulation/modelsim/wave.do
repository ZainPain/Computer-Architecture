...
add wave -noupdate -label load_data1 -radix hexadecimal /mp2_tb/dut/CACHE/CACHE_DATAPATH/load_data1
...
add wave -noupdate -label load_data2 -radix hexadecimal /mp2_tb/dut/CACHE/CACHE_DATAPATH/load_data2
...
WaveRestoreCursors {{Cursor 1} {1034900 ps} 0}
...
update
WaveRestoreZoom {1048557 ps} {1081189 ps}
